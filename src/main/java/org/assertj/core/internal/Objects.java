...
public class Objects {
  ...
  private boolean objectIsInstanceOfOneOfGivenClasses(Object actual, Class<?>[] types, AssertionInfo info) {
    ...
    for (Class<?> type : types) {
      if (type == null) {
        ...
        throw new NullPointerException(format(format, info.presentation().toStringOf(types)));
      }
  ...
  public void assertEqual(AssertionInfo info, Object actual, Object expected) {
    ...
    throw failures.failure(info, shouldBeEqual(actual, expected, comparisonStrategy, info.presentation()));
  }
  ...
  public void assertNull(AssertionInfo info, Object actual) {
    ...
    throw failures.failure(info, shouldBeEqual(actual, null, comparisonStrategy, info.presentation()));
  }
