...
public class MessageFormatter {
   ...
   * <code>{@link org.assertj.core.presentation.Presentation#toStringOf(Object)}</code>.
   * </ol>
   * 
   ...
   */
  public String format(Description d, Presentation p, String format, Object... args) {
    checkNotNull(format);
    checkNotNull(args);
    return descriptionFormatter.format(d) + formatIfArgs(format, format(p, args));
  }

  private Object[] format(Presentation p, Object[] args) {
  ...
  private String asText(Presentation p, Object o) {
