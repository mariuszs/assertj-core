...
/**
 * Tests for <code>{@link ShouldNotBeEqual#create(org.assertj.core.description.Description, org.assertj.core.presentation.Presentation)}</code>.
 * 
 * @author Alex Ruiz
...
public class ShouldNotBeEqual_create_Test {
  ...
  public void should_create_error_message() {
    String message = factory.create(new TestDescription("Jedi"), new StandardPresentation());
    assertEquals("[Jedi] \nExpecting:\n <\"Yoda\">\nnot to be equal to:\n <\"Luke\">\n", message);
  }
