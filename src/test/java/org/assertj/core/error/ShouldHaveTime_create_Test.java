...
/**
 * Tests for <code>{@link ShouldHaveTime#create(org.assertj.core.description.Description, org.assertj.core.presentation.Presentation)}</code>.
 * 
...
public class ShouldHaveTime_create_Test {
  ...
  public void should_create_error_message() throws ParseException {
    ...
    String message = shouldHaveTime(date, 123).create(new TextDescription("Test"), new StandardPresentation());
