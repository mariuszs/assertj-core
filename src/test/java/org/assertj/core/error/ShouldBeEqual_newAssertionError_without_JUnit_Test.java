...
public class ShouldBeEqual_newAssertionError_without_JUnit_Test {
  ...
  public void setUp() {
    ...
    factory = (ShouldBeEqual) shouldBeEqual("Luke", "Yoda", StandardPresentation.instance());
  ...
  public void should_create_AssertionError_if_created_ComparisonFailure_is_null() throws Exception {
    ...
    AssertionError error = factory.newAssertionError(description, StandardPresentation.instance());
    check(error);
  }
