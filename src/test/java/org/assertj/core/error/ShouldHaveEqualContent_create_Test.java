...
/**
 * Tests for <code>{@link ShouldHaveEqualContent#create(org.assertj.core.description.Description, org.assertj.core.presentation.Presentation)}</code>.
 * 
 * @author Yvonne Wang
...
public class ShouldHaveEqualContent_create_Test {
  ...
  public void should_create_error_message_file_even_if_content_contains_format_specifier() {
    ...
    assertEquals(b.toString(), factory.create(new TextDescription("Test"), new StandardPresentation()));
  }
