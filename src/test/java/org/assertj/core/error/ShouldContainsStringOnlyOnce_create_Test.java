...
public class ShouldContainsStringOnlyOnce_create_Test {
  ...
  public void should_create_error_message_when_string_to_search_appears_several_times() {
    String message = factoryWithSeveralOccurences.create(new TestDescription("Test"), new StandardPresentation());
    assertEquals(
  ...
  public void should_create_error_message_when_string_to_search_does_not_appear() {
    String message = factoryWithNoOccurence.create(new TestDescription("Test"), new StandardPresentation());
    assertEquals(
