...
/**
 * Tests for <code>{@link ElementsShouldBeExactly#create(Description, org.assertj.core.presentation.Presentation)}</code>.
 * 
 * @author Nicolas François
 */
public class ElementsShouldHaveAtLeast_create_Test {
