...
/**
 * Tests for <code>{@link Arrays#format(org.assertj.core.presentation.Presentation, Object)}</code>.
 * 
 * @author Alex Ruiz
 */
public class Arrays_format_Test {
  ...
  public void should_return_null_if_array_is_null() {
    assertNull(Arrays.format(StandardPresentation.instance(), null));
  }

  @Test
  public void should_return_empty_brackets_if_array_is_empty() {
    assertEquals("[]", Arrays.format(StandardPresentation.instance(), new Object[0]));
  }

  @Test
  public void should_format_Object_array() {
    Object o = new Object[] { "First", 3 };
    assertEquals("[\"First\", 3]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_boolean_array() {
    Object o = new boolean[] { true, false };
    assertEquals("[true, false]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_byte_array() {
    Object o = new byte[] { (byte) 3, (byte) 8 };
    assertEquals("[3, 8]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_byte_array_in_hex_representation() {
    Object o = new byte[] { (byte) 3, (byte) 8 };
    assertEquals("[03:08]", Arrays.format(new HexadecimalPresentation(), o));
  }

  @Test
  public void should_format_char_array() {
    Object o = new char[] { 'a', 'b' };
    assertEquals("['a', 'b']", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_double_array() {
    Object o = new double[] { 6.8, 8.3 };
    assertEquals("[6.8, 8.3]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_float_array() {
    Object o = new float[] { 6.1f, 8.6f };
    assertEquals("[6.1f, 8.6f]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_int_array() {
    Object o = new int[] { 78, 66 };
    assertEquals("[78, 66]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_long_array() {
    Object o = new long[] { 160l, 98l };
    assertEquals("[160L, 98L]", Arrays.format(StandardPresentation.instance(), o));
  }

  @Test
  public void should_format_short_array() {
    Object o = new short[] { (short) 5, (short) 8 };
    assertEquals("[5, 8]", Arrays.format(StandardPresentation.instance(), o));
  }
}
