...
/**
 * Tests for {@link StandardPresentation.instance()#toStringOf(Object)}.
 *
...
public class ToString_toStringOf_Test {
  ...
  public void should_return_null_if_object_is_null() {
    assertNull(StandardPresentation.instance().toStringOf(null));
  }

  @Test
  public void should_quote_String() {
    assertEquals("\"Hello\"", StandardPresentation.instance().toStringOf("Hello"));
  }

  @Test
  public void should_quote_empty_String() {
    assertEquals("\"\"", StandardPresentation.instance().toStringOf(""));
  }
  ...
  public void should_return_toString_of_File() {
    ...
    assertEquals(path, StandardPresentation.instance().toStringOf(o));
  }

  @Test
  public void should_return_toString_of_Class_with_its_name() {
    assertEquals("java.lang.Object", StandardPresentation.instance().toStringOf(Object.class));
  }

  @Test
  public void should_return_toString_of_Collection_of_String() {
    Collection<String> collection = newArrayList("s1", "s2");
    assertEquals("[\"s1\", \"s2\"]", StandardPresentation.instance().toStringOf(collection));
  }
  ...
  public void should_return_toString_of_Collection_of_arrays() {
    ...
    assertEquals("[[true, false], [true, false, true]]", StandardPresentation.instance().toStringOf(collection));
  }
  ...
  public void should_return_toString_of_Collection_of_Collections() {
    ...
    assertEquals("[[\"s1\", \"s2\"], [\"s3\", \"s4\", \"s5\"]]", StandardPresentation.instance().toStringOf(collection));
  }
  ...
  public void should_return_toString_of_Map() {
    ...
    map.put("key1", "value1");
    map.put("key2", "value2");
    assertEquals("{\"key1\"=\"value1\", \"key2\"=\"value2\"}", StandardPresentation.instance().toStringOf(map));
  }

  @Test
  public void should_return_toString_of_array() {
    assertEquals("[\"s1\", \"s2\"]", StandardPresentation.instance().toStringOf(array("s1", "s2")));
  }

  @Test
  public void should_return_toString_of_array_of_arrays() {
    String[][] array = array(array("s1", "s2"), array("s3", "s4", "s5"));
    assertEquals("[[\"s1\", \"s2\"], [\"s3\", \"s4\", \"s5\"]]", StandardPresentation.instance().toStringOf(array));
  }

  @Test
  public void should_return_toString_of_array_of_Class() {
    Class<?>[] array = { String.class, File.class };
    assertEquals("[java.lang.String, java.io.File]", StandardPresentation.instance().toStringOf(array));
  }
  ...
  public void should_return_toString_of_calendar() {
    ...
    assertEquals("2011-01-18T23:53:17", StandardPresentation.instance().toStringOf(calendar));
  }

  @Test
  public void should_return_toString_of_date() {
    Date date = new GregorianCalendar(2011, Calendar.JUNE, 18, 23, 53, 17).getTime();
    assertEquals("2011-06-18T23:53:17", StandardPresentation.instance().toStringOf(date));
  }
  ...
  public void toString_with_anonymous_comparator() {
    ...
    assertEquals("'Anonymous Comparator class'", StandardPresentation.instance().toStringOf(anonymousComparator));
  }

  @Test
  public void should_format_longs_and_integers() {
    assertFalse(StandardPresentation.instance().toStringOf(20L).equals(toStringOf(20)));
  ...
  private String toStringOf(Object o) {
    return StandardPresentation.instance().toStringOf(o);
  }
}
