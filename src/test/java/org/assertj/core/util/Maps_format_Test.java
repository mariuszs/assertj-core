...
public class Maps_format_Test {
  ...
  public void should_return_null_if_Map_is_null() {
    assertNull(Maps.format(StandardPresentation.instance(), null));
  }

  @Test
  public void should_return_empty_braces_if_Map_is_empty() {
    assertEquals(Maps.format(StandardPresentation.instance(), new HashMap<String, String>()), "{}");
  }
  ...
  public void should_format_Map() {
    ...
    assertEquals("{\"One\"=java.lang.String, \"Two\"=java.io.File}", Maps.format(StandardPresentation.instance(), map));
  }
}
